...
export class CustomersService {
  ...
  public getCustomers() : Observable<Array<Customer>> {
    return this.http.get<Array<Customer>>(environment.backendHost+"/admin/comptes");
  }
  ...
  public blockCustomer(customer : Customer, id: number) : Observable<Customer> {
    return this.http.post<Customer>(`${environment.backendHost}/compte/${customer.numCompte}/desactivate`, customer);
  }
  public unblockCustomer(customer : Customer, id: number) : Observable<Customer> {
    return this.http.post<Customer>(`${environment.backendHost}/compte/${customer.numCompte}/activate`, customer);
  }
