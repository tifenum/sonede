...
export class OrdersService {
  ...
  constructor(private pipe: DecimalPipe, private datePipe: DatePipe, private http : HttpClient) {
    this._search$.pipe(
  ...
  public getAccounts() : Observable<Array<Account>>{
    return this.http.get<Array<Account>>(environment.backendHost+"/client/accounts");
  }

  public getAccountsByCustomer(customer : any) : Observable<Array<Account>> {
    const params = new HttpParams({ fromObject: customer });
    return this.http.get<Array<Account>>(environment.backendHost+"/accounts/customer",{ params, responseType: 'json' });
  }
  ...
  public debit(accountId : string, amount : number, description : string){
    ...
    return this.http.post(environment.backendHost+"/transaction/retrait",data);
  }
  ...
  public credit(accountId : string, amount : number, description : string){
    let data = {
      numCompte: accountId,
      montant: amount
    };    return this.http.post(environment.backendHost+"/transaction/versement",data);
  }

  public transfer(accountSource : string, accountDestination : string, amount : number, description : string){
    let data = {
      fromCompte: accountSource,
      toCompte: accountDestination,
      montant: amount,
    };
    return this.http.post(`${environment.backendHost}/transaction/virement`, data);
  }
